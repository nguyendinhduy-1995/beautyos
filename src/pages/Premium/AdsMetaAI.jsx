...
export default function AdsMetaAI() {
    ...
    return (
        <div className="fade-in" style={{ maxWidth: 1200, margin: '0 auto' }}>
            <div style={{ background: 'linear-gradient(135deg, #1877f2, #42a5f5)', borderRadius: 16, padding: '24px 28px', marginBottom: 20, position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: 16 }}>
                    ...
                    <div style={{ flex: 1 }}>
                        <h2 style={{ margin: 0, color: 'white', fontSize: 20, fontWeight: 800 }}>Quảng cáo Meta AI</h2>
                        <p style={{ margin: '4px 0 0', color: 'rgba(255,255,255,0.8)', fontSize: 13 }}>AI tối ưu chiến dịch Facebook/Instagram Ads • ROAS tracking</p>
                    </div>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 20 }}>
                {[{ id: 'campaigns', label: '📋 Chiến dịch' }, { id: 'ai', label: '🤖 AI Gợi ý' }].map(t => (
                    <button key={t.id} onClick={() => setTab(t.id)} style={{
                        ...
                        fontSize: 13, fontWeight: 600, background: tab === t.id ? '#1877f2' : '#f1f5f9', color: tab === t.id ? 'white' : '#64748b',
                    }}>{t.label}</button>
                ))}
            </div>
