            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div className="card">
                    ...
                    <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div className="mobile-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><div><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Tự động phân ticket</div><div style={{ fontSize: '0.75rem', color: 'var(--gray-500)' }}>Phân ticket cho nhân viên tự động</div></div><Toggle checked={settings.autoAssign} onChange={v => setSettings(s => ({ ...s, autoAssign: v }))} /></div>
                        <div className="mobile-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><div><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Tự động trả lời</div><div style={{ fontSize: '0.75rem', color: 'var(--gray-500)' }}>Gửi tin nhắn tự động khi nhận ticket</div></div><Toggle checked={settings.autoReply} onChange={v => setSettings(s => ({ ...s, autoReply: v }))} /></div>
                        <div className="mobile-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><div><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Tự đóng ticket</div><div style={{ fontSize: '0.75rem', color: 'var(--gray-500)' }}>Đóng ticket không phản hồi</div></div><Toggle checked={settings.autoClose} onChange={v => setSettings(s => ({ ...s, autoClose: v }))} /></div>
                ...
                <div className="card">
                    ...
                    <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        <div className="mobile-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><div><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Thông báo Zalo</div><div style={{ fontSize: '0.75rem', color: 'var(--gray-500)' }}>Gửi ZNS khi có ticket mới</div></div><Toggle checked={settings.zaloNotify} onChange={v => setSettings(s => ({ ...s, zaloNotify: v }))} /></div>
                        <div className="mobile-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><div><div style={{ fontWeight: 600, fontSize: '0.85rem' }}>Thông báo Email</div><div style={{ fontSize: '0.75rem', color: 'var(--gray-500)' }}>Gửi email khi có ticket mới</div></div><Toggle checked={settings.emailNotify} onChange={v => setSettings(s => ({ ...s, emailNotify: v }))} /></div>
